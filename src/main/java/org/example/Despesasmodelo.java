...
//
    ...
    public Despesasmodelo(int id, String categoria, String descricao, double valor, int parcelas, LocalDate dataDespesa, String forma, int nparcela) {
    ...
    public Despesasmodelo(){}

    List<Despesasmodelo> listaDespesas = new ArrayList<>();
    ...
    public void cadastrarDespesas(){
        ...
        for(int i =1; i <= parcelas;i++) {   //Cria uma loop para criar as multiplas despesas relacionada ao numero de parcela e adiciona a lista
            ...
            Despesasmodelo despesas = new Despesasmodelo(id,categoria,descricao,valor,parcelas,dataDespesa,forma,nparcela);
    ...
    public void consultarDespesas(Despesasmodelo despesas){
        System.out.println("DESPESAS CADASTRADAS: ");
        System.out.println("----------------------------------------------------");
        for(Despesasmodelo listarDespesas : listaDespesas){
    ...
    public void removerDespesas(Despesasmodelo despesas){
        for(Despesasmodelo despesas1 : listaDespesas){
    ...
    public void pesquisarPorCategoria(Despesasmodelo despesas){
    ...
    public void relatorioMensal(){
        ...
        for (Despesasmodelo despesas : listaDespesas){
